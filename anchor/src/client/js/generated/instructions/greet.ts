...
export type GreetInstruction<
  TProgram extends string = typeof TOKENVESTING_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof TOKENVESTING_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? TOKENVESTING_PROGRAM_ADDRESS;
